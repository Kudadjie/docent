...
- [Hardening & governance roadmap](thoughts_review_2026_04_29.md) — Phases A–C for post-1.0 polish (security, CLI robustness, state resilience); trigger on pre-launch hardening
...
- [Reading UI todos](ui_todos.md) — tracked open work on the Next.js Reading page frontend; read when picking up UI work
