...
- [Studio real-life tests](tasks/studio_real_life_tests.md) — 45-item manual test checklist; covers CLI, free tier, guide-files, MCP synthesis prompt, and paid backends; all results cleared for full re-run
