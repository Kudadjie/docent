...
import {
  FlaskConical, Play, AlertTriangle, Plus, ChevronDown, File, X, Search,
...
// Form primitives live in components/studio/controls.tsx (v2.3 split);
// re-exported here so page.tsx/_output.tsx import paths keep working.
import {
  AMBER_HDR, BLUE_HDR, INDIGO,
  Kbd, PrimaryBtn, GhostBtn, PillToggle, Segmented, StudioInput,
  FieldLabel, Field, Note, Toggle, Stepper, CodeBlock, Chip,
