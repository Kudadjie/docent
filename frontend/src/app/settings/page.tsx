                    ...
                    <div style={{ marginBottom: 16, border: '1px solid rgba(59,130,246,0.25)', borderRadius: 10, overflow: 'hidden' }}>
                      ...
                      <div style={{ padding: '14px 18px', background: 'rgba(59,130,246,0.04)', borderBottom: '1px solid rgba(59,130,246,0.15)' }}>
                        ...
                        {[
                          ...
                          { n: '3', text: <><strong style={{ color: 'var(--fg1)' }}>OAuth consent screen / Audience</strong> → click <strong style={{ color: 'var(--fg1)' }}>Publish app</strong>. This removes the test-user restriction. Google will show a one-time "unverified app" warning on first sign-in — click <em>Advanced → Go to app</em> to proceed. (Alternatively add your email under Test users, but publishing is simpler.)</> },
