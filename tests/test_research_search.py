...
class TestWebSearch:
    @patch("docent.bundled_plugins.studio.search._read_tavily_daily_requests")
    @patch("docent.bundled_plugins.studio.search._write_tavily_daily_requests")
...
class TestTavilySpendFile:
    ...
    def test_returns_path_under_cache_dir(self, tmp_docent_home):
        from docent.bundled_plugins.studio.search import _tavily_spend_file
...
class TestReadTavilyDailyRequests:
    ...
    def test_returns_zero_when_file_does_not_exist(self, tmp_docent_home):
        from docent.bundled_plugins.studio.search import _read_tavily_daily_requests

        result = _read_tavily_daily_requests()
        assert result == 0

    def test_returns_zero_when_file_has_stale_date(self, tmp_docent_home):
        from docent.bundled_plugins.studio.search import (
